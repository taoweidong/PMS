	...
	<div region="west" style="width: 200px; height: 500px" title="导航菜单"
		...
		<div class="easyui-accordion">
			<div title="个人信息管理" data-options="iconCls:'icon-user'"
				style="padding: 10px">
				<a
					href="javascript:openTab('个人信息管理','persionInfoManage','icon-user-edit')"
			...
			<div title="部门管理" data-options="iconCls:'icon-user-business-boss'"
				style="padding: 10px">
				<a
					href="javascript:openTab('部门信息管理','departmentManage','icon-user-business-boss')"
					class="easyui-linkbutton"
			...
			<div title="岗位管理" data-options="iconCls:'icon-report-key'"
				style="padding: 10px">
				<a
					href="javascript:openTab('个人职位管理','applyInduction','icon-report-edit')"
					class="easyui-linkbutton"
					data-options="plain:true,iconCls:'icon-report-edit'"
					style="width: 150px;">个人职位管理</a> <a
					href="javascript:openTab('岗位信息管理','positionsManage','icon-report-disk')"
					class="easyui-linkbutton"
					data-options="plain:true,iconCls:'icon-report-disk'"
					style="width: 150px;">岗位管理</a> <a
					href="javascript:openTab('岗位申请审批','applyInductionApprove','icon-report')"
					class="easyui-linkbutton"
			...
			<div title="职工管理" data-options="iconCls:'icon-user-group'"
				...
				<a
					href="javascript:openTab(' 职工信息管理','employeeManage','icon-group-edit')"
					class="easyui-linkbutton"
			...
			<div title="公告管理" data-options="iconCls:'icon-bricks'"
				style="padding: 10px">
				<a
					href="javascript:openTab('公告管理','noticManager','icon-camera-edit')"
					class="easyui-linkbutton"
			...
			<div title="系统管理" data-options="iconCls:'icon-wrench'"
				...
				<a
					href="javascript:openTab('政治面貌管理','politicalStatusManager','icon-group-edit')"
					class="easyui-linkbutton"
					data-options="plain:true,iconCls:'icon-group-edit'"
					style="width: 150px;"> 政治面貌管理</a> <a
					href="javascript:openTab('管理员管理','adminManager','icon-group-key')"
					class="easyui-linkbutton"
					data-options="plain:true,iconCls:'icon-group-key'"
					style="width: 150px;">管理员管理</a> <a
			...
			<table cellspacing="8px">
				<tr>
					...
					<td><input type="text" id="userName" name="userName"
						value="XXXXXX" readonly="readonly" style="width: 200px" /></td>
				</tr>
				<tr>
					<td>原密码：</td>
					<td><input type="password" id="oldPassword"
						class="easyui-validatebox" maxlength="12"
						validType="newEqualToOld['XXX']" invalidMessage="密码验证失败" value=""
