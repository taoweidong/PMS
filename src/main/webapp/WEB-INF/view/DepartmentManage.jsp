...
<body>
	<div class="easyui-layout" data-options="fit:true">
		...
		<div id="wu-toolbar-2">
			<div class="wu-toolbar-button">
				<a href="javascript:openDepartmentAddDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a> <a href="javascript:openDepartmentModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a> <a href="javascript:deleteDepartment()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除</a>
			</div>
			<div class="wu-toolbar-search">

				<label>部门名ID：</label> <input name="s_DEP_ID" id="s_DEP_ID" class="wu-text" style="width: 100px;"> <label>部门名称：</label> <input name="s_DEP_NAME" id="s_DEP_NAME" class="wu-text" style="width: 100px;"> <label>领导姓名：</label> <input class="easyui-combobox" id="s_DEP_LEADER" name="s_DEP_LEADER" data-options="panelHeight:'auto',editable:false,valueField:'EMP_NO',textField:'EMP_NAME',url:'comboListEmployee'" /> <a href="javascript:searchDepartment()" class="easyui-linkbutton" iconCls="icon-search">开始检索</a>
			</div>
		</div>
		<!-- End of toolbar -->
		<table id="wu-datagrid-2" class="easyui-datagrid" toolbar="#wu-toolbar-2" fitColumns="true" pagination="true" fit="true" rownumbers="true" url="queryDepartment">
			<thead>
				<tr>
	...
	<div id="dia-buttons">
		<a href="javascript:saveDepartment()" class="easyui-linkbutton" iconCls="icon-ok">保存</a> <a href="javascript:closeDepartmentDialog()" class="easyui-linkbutton" iconCls="icon-cancel">关闭</a>
	</div>
</body>
</html>
