...
public class PositionsServlet extends BaseServlet
{
    ...
    /**
     * Author:Taowd 功能：新增岗位信息信息 开发日期：2017-5-9-下午1:15:27
     *
     * @param request
     * @param response
    ...
    /**
     * Author:Taowd 功能：删除岗位信息信息 开发日期：2017-5-9-下午1:17:09
     *
     * @param request
     * @param response
     * @throws ServletException
    ...
    /**
     * Author:Taowd 功能：修改岗位信息信息 开发日期：2017-5-9-下午1:17:38
     *
     * @param request
     * @param response
     * @throws ServletException
    ...
    /**
     * Author:Taowd 功能：查询岗位信息信息列表 开发日期：2017-5-9-下午1:18:49
     *
     * @param request
     * @param response
     * @throws ServletException
        ...
        IOException
    {
        ...
        try
        {
            ...
            JSONArray jsonArray = JsonUtil.formatRsToJsonArray(
                PositionsInfoDao.PositionsInfoList(con, pageBean, grade));// 取得json数据
    ...
    /**
     * Author:Taowd 功能：查询岗位信息下拉框信息 开发日期：2017-5-9-下午1:19:22
     *
     * @param request
     * @param response
     * @throws ServletException
        ...
        IOException
    {
        ...
        try
        {
            ...
            jsonArray.addAll(JsonUtil.formatRsToJsonArray(
                PositionsInfoDao.PositionsInfoList(con, null, new PositionsInfoBean())));// 取得json数据
