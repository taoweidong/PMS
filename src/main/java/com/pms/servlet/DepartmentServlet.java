...
public class DepartmentServlet extends BaseServlet {
	...
	public void DepartmentListInfo(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Object jsonArray = JsonUtil
					.formatRsToJsonArray(DepartmentDao.departmentList(con, pageBean, grade));// 取得json数据
	...
	public void DepartmentComboboxInfo(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			resultMap.put("DEP_ID", "");
			resultMap.put("DEP_NAME", "请选择...");
			jsonArray.add(jsonObject);
			// 加入整个集合
			// resultMap.put(
			// JsonUtil.formatRsToJsonArray(DepartmentDao.departmentList(con, null, null)));//
			// 取得json数据
