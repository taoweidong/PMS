...
public class PoliticalStatusServlet extends BaseServlet
{
    ...
    /**
     * Author:Taowd 功能：新增政治面貌信息 开发日期：2017-5-9-下午1:15:27
     * 
     * @param request
     * @param response
    ...
    /**
     * Author:Taowd 功能：删除政治面貌信息 开发日期：2017-5-9-下午1:17:09
     * 
     * @param request
     * @param response
     * @throws ServletException
    ...
    /**
     * Author:Taowd 功能：修改政治面貌信息 开发日期：2017-5-9-下午1:17:38
     * 
     * @param request
     * @param response
     * @throws ServletException
    ...
    /**
     * Author:Taowd 功能：查询政治面貌信息列表 开发日期：2017-5-9-下午1:18:49
     * 
     * @param request
     * @param response
     * @throws ServletException
        ...
        IOException
    {
        ...
        try
        {
            ...
            JSONArray jsonArray = JsonUtil.formatRsToJsonArray(
                PoliticalStatusDao.politicalStatusList(con, pageBean, grade));// 取得json数据
    ...
    /**
     * Author:Taowd 功能：查询政治面貌下拉框信息 开发日期：2017-5-9-下午1:19:22
     * 
     * @param request
     * @param response
     * @throws ServletException
        ...
        IOException
    {
        ...
        try
        {
            ...
            jsonArray.addAll(JsonUtil.formatRsToJsonArray(
                PoliticalStatusDao.politicalStatusList(con, null, null)));// 取得json数据
