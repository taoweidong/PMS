...
public class AdministratorDao {
	...
	public ResultSet getAdminInfo(Connection con, PageBean pageBean, Administrator adminInfo)
		...
		if (adminInfo != null && StringUtils.isNotBlank(adminInfo.getAdmin_no())) {
			sb.append(" and t_administrator.ADMIN_NO like '%" + adminInfo.getAdmin_no() + "%'");
		}
		if (adminInfo != null && StringUtils.isNotBlank(adminInfo.getAdmin_name())) {
			sb.append(" and t_administrator.ADMIN_NAME like '%" + adminInfo.getAdmin_name() + "%'");
		}
		if (adminInfo != null && StringUtils.isNotBlank(adminInfo.getAdmin_phone())) {
			sb.append(
	...
	/**
	 * Author:Taowd 功能：获取管理员数量 开发日期：2017-4-11-下午9:55:02
	 * @param con
	 * @param adminInfo
	 * @return
	 * @throws SQLException
	...
	/**
	 * Author:Taowd 功能：修改管理员信息 开发日期：2017-4-12-下午1:58:39
	 * @param con
	 * @param adminInfo
	 * @return
	 * @throws Exception
	...
	public int adminModify(Administrator adminInfo) throws Exception {
		...
		if (adminInfo != null && StringUtils.isNotBlank(adminInfo.getAdmin_pwd())) {
			QueryRunner queryRun = new QueryRunner(DbUtils.getDataSource());
	...
	/**
	 * Author:Taowd 功能：管理员修改个人信息，不能在此修改密码 开发日期：2017-4-27-下午2:20:33
	 * @param con
	 * @param adminInfo
	 * @return
	 * @throws Exception
	...
	/**
	 * Author:Taowd 功能：管理员修改密码 开发日期：2017-4-19-下午1:43:04
	 * @param con
	 * @param adminInfo
	 * @return
	 * @throws Exception
	...
	/**
	 * Author:Taowd 功能：检查管理员admin_no是否已经存在 开发日期：2017-4-18-下午12:59:55
	 * @param con
	 * @param aDMIN_NO
	 * @return
	 * @throws SQLException
	...
	/**
	 * Author:Taowd 功能：增加管理员 开发日期：2017-4-18-下午1:04:06
	 * @param con
	 * @param adminBean
	 * @return
	 * @throws Exception
	...
	/**
	 * Author:Taowd 功能：删除管理员信息 开发日期：2017-4-19-下午1:20:28
	 * @param con
	 * @param delIds
	 * @return
	 * @throws SQLException
	...
	/**
	 * Author:Taowd 功能：设置超级管理员 开发日期：2017-4-24-下午8:02:31 啊三大大.
	 * <p>
	 * 大师对话框敬爱的
	 * </p>
	 * @param con
	...
	/**
	 * Author:Taowd 功能：取消超级管理员的设置 开发日期：2017-4-25-下午12:43:50
	 * @param string
	 * @return
	 * @throws SQLException
	 */
	...
	/**
	 * Author:Taowd 功能：检查是否为超级管理员 开发日期：2017-4-25-下午1:55:16
	 * @param string
	 * @return true 是超级管理员
	 * @throws SQLException
	 */
