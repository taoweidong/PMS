...
public class DepartmentDao {
	...
	public static ResultSet departmentList(Connection con, PageBean pageBean, DepartmentBean demp)
		...
		StringBuffer sb = new StringBuffer(
				"SELECT dep.DEP_ID,dep.DEP_NAME,DEP_LEADER,emp.EMP_NAME,emp.EMP_Phone "
						+ "FROM pms.t_department dep "
						+ "LEFT JOIN pms.t_employee emp ON dep.DEP_LEADER = emp.EMP_NO ");
		if (demp != null && StringUtils.isNotBlank(demp.getDep_Id())) {
			sb.append(" and dep.DEP_ID like '%" + demp.getDep_Id() + "%'");
		}
		if (demp != null && StringUtils.isNotBlank(demp.getDep_Name())) {
			sb.append(" and dep.DEP_NAME like '%" + demp.getDep_Name() + "%'");
		}
		if (demp != null && StringUtils.isNotBlank(demp.getDep_Leader())) {
	 ...
	 * @throws Exception
	 */
	public static int departmentCount(Connection con, DepartmentBean demp) throws Exception {
	 ...
	 * @throws SQLException
	 */
	public static int departmentDelete(Connection con, String delIds) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public static boolean isExistence(Connection con, String ps_Type) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public static int departmentModify(Connection con, DepartmentBean db) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public static int departmentAdd(Connection con, DepartmentBean db) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public static boolean getPosInfoByDepId(Connection con, String DepId) throws SQLException {
