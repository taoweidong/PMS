...
public class PositionsInfoDao {
	...
	public static ResultSet PositionsInfoList(Connection con, PageBean pageBean,
		...
		if (grade != null && StringUtils.isNotBlank(grade.getPos_Name())) {
			sb.append("and pi.POS_NAME like '%" + grade.getPos_Name() + "%'");
		}
		if (grade != null && StringUtils.isNotBlank(grade.getDep_Id())) {
	 ...
	 * @throws Exception
	 */
	public static int PositionsInfoCount(Connection con, PositionsInfoBean grade) throws Exception {
		StringBuffer sb = new StringBuffer(
				"SELECT count(*) as total FROM pms.t_positionsinfo pi,pms.t_department dep WHERE pi.DEP_ID = dep.DEP_ID");
		if (StringUtils.isNotBlank(grade.getPos_Name())) {
			sb.append(" and pi.POS_NAME like '%" + grade.getPos_Name() + "%'");
		}
		PreparedStatement pstmt = con.prepareStatement(sb.toString());
	 ...
	 * @throws Exception
	 */
	public static int PositionsInfoDelete(Connection con, String delIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static boolean getEmpByPosId(Connection con, String pos_Id) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static int PositionsInfoAdd(Connection con, PositionsInfoBean grade) throws Exception {
	 ...
	 * @throws SQLException
	 */
	public static boolean IsExistence(Connection con, String pos_Id) throws SQLException {
