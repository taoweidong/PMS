...
/**
 * @author Taowd 功 能：入职信息 编写时间：2017-4-11-下午8:38:05
 */
public class InductionInfoDao
{
    /**
     * Author:Taowd 功能：查询所有员工的入职信息--管理员权限才可以--即入职审批时的界面 开发日期：2017-4-11-下午8:39:05
     *
     * @param con
     * @param pageBean
     * @param demp
    ...
    /**
     * Author:Taowd 功能：检查该部门是否已经申请过了，如果申请过了，就不允许再次申请 开发日期：2017-4-14-下午1:18:28
     *
     * @param con
     * @param pos_Id
