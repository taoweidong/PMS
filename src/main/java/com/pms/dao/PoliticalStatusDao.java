...
public class PoliticalStatusDao {
	...
	public static ResultSet politicalStatusList(Connection con, PageBean pageBean,
		...
		if (ps != null && StringUtils.isNotBlank(ps.getPs_type())) {
			sb.append(" and t_politicalstatus.PS_TYPE like '%" + ps.getPs_type() + "%'");
		}
		if (ps != null && StringUtils.isNotBlank(ps.getPs_name())) {
	 ...
	 * @throws Exception
	 */
	public static int PoliticalStatusDelete(Connection con, String delIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static int PoliticalStatusAdd(Connection con, PoliticalStatusBean ps) throws Exception {
	 ...
	 * @throws SQLException
	 */
	public static boolean getEmpByPsType(Connection con, String psType) throws SQLException {
