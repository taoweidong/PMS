...
/**
 * easui中的tree_data.json数据,只能有一个root节点 [{ "id":1, "text":"Folder1", "iconCls":"icon-save",
 * "children":[{ "text":"File1", "checked":true }] }] 提供静态方法formatTree(List<TreeJson> list) 返回结果
