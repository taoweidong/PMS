...
public class PositionsInfoBean {
	...
	public String toString() {
		return "岗位信息实体 [pos_Id=" + pos_Id + ", dep_Id=" + dep_Id
				+ ", pos_Name=" + pos_Name + ", pox_Content=" + pos_Content
				+ ", pos_Salary=" + pos_Salary + ", pos_Allowance="
				+ pos_Allowance + ", pos_Perquisites=" + pos_Perquisites
	...
	public PositionsInfoBean(String pos_Id, String dep_Id, String pos_Name,
			String pox_Content, double pos_Salary, double pos_Allowance,
			double pos_Perquisites, String ext1, String ext2, String ext3) {
		super();
		this.pos_Id = pos_Id;
		this.dep_Id = dep_Id;
