 ...
 * 
 * @author Taowd
 * 功        能：员工的入职信息实体，职工的岗位信息等。
 * 编写时间：2017-4-8-上午10:29:59
 */
public class InductionInfoBean {
	...
	public String toString() {
		return "入职信息实体 [ind_Id=" + ind_Id + ", emp_No=" + emp_No + ", pos_Id="
				+ pos_Id + ", ind_Date=" + ind_Date + ", ind_State="
				+ ind_State + ", ind_Enddate=" + ind_Enddate + ", ind_Reasons="
				+ ind_Reasons + ", ext1=" + ext1 + ", ext2=" + ext2 + ", ext3="
				+ ext3 + "]";
	}
	...
	public InductionInfoBean(String ind_Id, String emp_No, String pos_Id,
			String ind_Date, String ind_State, String ind_Enddate,
			String ind_Reasons, String ext1, String ext2, String ext3) {
		super();
		this.ind_Id = ind_Id;
		this.emp_No = emp_No;
		this.pos_Id = pos_Id;
