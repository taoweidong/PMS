...
public class NoticeBean {
	...
	public String toString() {
		return "公告实体 [not_Id=" + not_Id + ", not_Title=" + not_Title
				+ ", not_Content=" + not_Content + ", not_Date=" + not_Date
				+ ", not_Author=" + not_Author + ", not_ext1=" + not_ext1
				+ ", not_ext2=" + not_ext2 + ", not_ext3=" + not_ext3 + "]";
	}
	...
	public NoticeBean(String not_Id, String not_Title, String not_Content,
			Date not_Date, String not_Author, String not_ext1,
			String not_ext2, String not_ext3) {
		super();
		this.not_Id = not_Id;
