	...
	public void NoticeListInfo(HttpServletRequest request,
		...
		try {
			...
			JSONArray jsonArray = JsonUtil.formatRsToJsonArray(NoticeDao
					.NoticeList(con, pageBean, notice, startDate, endDate));// 取得json数据
