	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div id="wu-toolbar-2">
			...
			<div class="wu-toolbar-search">
				<label>部门名ID：</label>
				<input name="s_DEP_ID" id="s_DEP_ID" class="wu-text" style="width:100px;">
				<label>部门名称：</label>
				<input name="s_DEP_NAME" id="s_DEP_NAME" class="wu-text" style="width:100px;">
				<label>领导姓名：</label>
				...
				<a href="javascript:searchDepartment()" class="easyui-linkbutton" iconCls="icon-search">开始检索</a>
			</div>
		</div>
		<!-- End of toolbar -->
		<table id="wu-datagrid-2" class="easyui-datagrid" toolbar="#wu-toolbar-2" fitColumns="true" pagination="true" fit="true" rownumbers="true"
			...
			<thead>
				<tr>
					...
					<th field="DEP_LEADER" hidden="true" width=" width=" 50" align="center">领导工号</th>
		...
		<form id="wu-form-2" method="post">
			<table>
				<tr>
					...
					<td>
						<input type="text" name="DEP_NAME" id="DEP_NAME" class="easyui-validatebox" required="true" />
					</td>
				</tr>
				<tr>
