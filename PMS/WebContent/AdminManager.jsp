...
<body>
	<div id="tb">
		<div>
			...
			<a href="javascript:setSuperAdmin()" class="easyui-linkbutton" iconCls="icon-vector-add" plain="true">设置超级管理员</a>
			<a href="javascript:cancelSetSuperAdmin()" class="easyui-linkbutton" iconCls="icon-vector-delete" plain="true">取消超级管理员</a>
			<a href="javascript:deleteAdminInfo()" class="easyui-linkbutton" iconCls="icon-css-delete" plain="true">删除</a>
		</div>
		<div>
			&nbsp;登录账号：&nbsp;
			<input type="text" class="wu-text" style="width:100px" name="s_ADMIN_NO" id="s_ADMIN_NO" size="10" />
			&nbsp;姓名：&nbsp;
			<input type="text" class="wu-text" style="width:100px" name="s_ADMIN_NAME" id="s_ADMIN_NAME" size="20" />
			&nbsp;电话：&nbsp;
			<input type="text" class="wu-text" style="width:100px" name="s_ADMIN_PHONE" id="s_ADMIN_PHONE" size="11" />

			<a href="javascript:searchAdminInfo()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a>
		</div>
	</div>

	<table id="dg" title="个人信息" class="easyui-datagrid" fitColumns="true" pagination="true" fit="true" pageSize="20" rownumbers="true"
		...
		<form id="fm" method="post">
			<table>
				<tr>
					...
					<td>
						<input style="width: 150px" maxlength="10" type="text" name="ADMIN_NO" id="ADMIN_NO" class="easyui-validatebox" required="true" />
					</td>
					<td></td>
				...
				<tr>
					...
					<td>
						<input type="password" id="newPassword" name="newPassword" class="easyui-validatebox" required="true" style="width: 150px" />
					</td>
					<td></td>
					...
					<td>
						<input type="password" id="newPassword2" name="newPassword2" class="easyui-validatebox" required="true" validType="equalTo['#newPassword']"
							invalidMessage="两次输入的密码不一致" style="width: 150px" />
					</td>
